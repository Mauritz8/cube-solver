...
let assert_cross_bottom_face_is_solved cube =
  let fail_message =
    Printf.sprintf "Cross bottom face is solved: %s" (cube_to_string cube)
  in
  Alcotest.(check bool) fail_message true (cross_bottom_face_is_solved cube)

let assert_corners_bottom_layer_are_solved cube =
  let fail_message =
    Printf.sprintf "Corners bottom layer are solved: %s"
      (cube_to_string cube)
  in
  Alcotest.(check bool) fail_message true (corners_bottom_layer_are_solved cube)

let assert_edges_second_layer_are_solved cube =
  let fail_message =
    Printf.sprintf "Edges in second layer are solved: %s"
      (cube_to_string cube)
  in
  Alcotest.(check bool) fail_message true (edges_second_layer_are_solved cube)
...
let solve_cube_test scramble =
  ...
  | Ok solution ->
      ...
      assert_cross_bottom_face_is_solved solved_cube;
      assert_corners_bottom_layer_are_solved solved_cube;
      assert_edges_second_layer_are_solved solved_cube;
  ()
