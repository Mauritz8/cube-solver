...
let page cube =
  html [] [
    ...
    body [] [
      ...
      button [type_ "button"; id "move_up_counter_clockwise_btn"] [txt "U'"];
      button [type_ "button"; id "move_down_clockwise_btn"] [txt "D"];
      button [type_ "button"; id "move_down_counter_clockwise_btn"] [txt "D'"];
      button [type_ "button"; id "move_right_clockwise_btn"] [txt "R"];
      button [type_ "button"; id "move_right_counter_clockwise_btn"] [txt "R'"];
      button [type_ "button"; id "move_left_clockwise_btn"] [txt "L"];
      button [type_ "button"; id "move_left_counter_clockwise_btn"] [txt "L'"];
      button [type_ "button"; id "move_front_clockwise_btn"] [txt "F"];
      button [type_ "button"; id "move_front_counter_clockwise_btn"] [txt "F'"];
      button [type_ "button"; id "move_back_clockwise_btn"] [txt "B"];
      button [type_ "button"; id "move_back_counter_clockwise_btn"] [txt "B'"];
  ...
  @@ Dream.router [
    Dream.post "/api/move" (fun req ->
      ...
      let data = body
        ...
        |> make_move_req_body_of_yojson
      in
      Dream_html.respond (cube_div (move data.cube data.direction data.clockwise))
    );
